...
export default function AdminSidebar({ setSidebarOpen }) {
  const pathname = usePathname();

  return (
    <aside className="admin-sidebar w-60 min-h-screen bg-white border-r border-slate-100 flex flex-col py-6 px-3">
